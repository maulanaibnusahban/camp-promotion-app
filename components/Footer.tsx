    ...
    <footer className="flexCenter mb-24">
      <div className="padding-container max-container flex w-full flex-col gap-14">
              ...
              <FooterColumn title={FOOTER_CONTACT_INFO.title}>
                {FOOTER_CONTACT_INFO.links.map((link) => (
                  <Link href="" key={link.label} className="flex gap-4 md:flex-col lg:flex-row">
                    <p className="wehitespace-nowrap">{link.label}</p>
        ...
        <div className="flex flex-col gap-2">
          <p className="text-center text-gray-30 w-full regular-14">2024 Hilink | All rights reserved</p>
          <p className="text-center text-gray-30 w-full regular-14">By Maulana Ibnu Sahban</p>
        </div>
      </div>
    </footer>
  );
